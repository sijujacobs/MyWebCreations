...
//App.controller('memberController', ['$scope', 'dataService', function ($scope, dataService) {
    ...
    $scope.verifyMember = function (email, password) {
        ...
        dataFactory.verifyMember($scope.loggedMember)
        .then(function (response) {
    ...
    $scope.memberSingleClick = function(sMember, sIndex){
     ...
     $scope.directiveCallBack = function(sMember, sIndex){
        console.log("memberController: directiveCallBack--- " +  sMember.firstName + ", index : " + sIndex);
        $scope.selectedRowIndex = sIndex;
        $scope.selectedMember = sMember
        //console.log("memberController: memberClick--- call Back function from controller  : " + sMember.firstName + ", selectedMember Index : " + $scope.selectedRowIndex );
...
App.directive("selectedMember", [function () {
    return{
        restrict: 'A',
        scope:{
            smember: "=",
...
App.directive('memberViewModal', function() {
    return {
      restrict: 'E',
